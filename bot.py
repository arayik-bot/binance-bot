...
python3 -c "
import ast
with open('/mnt/user-data/outputs/bot.py') as f: src=f.read()
try: ast.parse(src); print('✅ OK —', src.count(chr(10)), 'lines')
except SyntaxError as e: print(f'❌ Line {e.lineno}: {e.msg}')
"
Output
